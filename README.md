...
return [
    'components' => [
        ...
        'user' => [
            'class' => 'RagnarIndie\yii2\user\components\User',
        ],
        'mailer' => [
    ...
    'modules' => [
        'user' => [
            'class' => 'RagnarIndie\yii2\user\Module',
...
change the namespaces in the files. Replace ```RagnarIndie\yii2\user``` with ```app\modules\user```.
